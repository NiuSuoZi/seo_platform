...
class My extends TagLib {
    ...
    protected $tags=array(
        ...
        'codemirrorjs' => array('','close' => 0),
        'codemirrorcss' => array('','close' => 0),
        'jqueryui' => array('','close' => 0)
        );
...
php;
    ...
    public function _jqueryui(){
        $str=<<<php
<link rel="stylesheet" href="__PUBLIC__/statics/jquery-ui/jquery-ui.min.css">
<script src="__PUBLIC__/statics/jquery-ui/jquery-ui.min.js"></script>
<script src="__PUBLIC__/statics/jquery-ui/jquery.ui.touch-punch.min.js"></script>    
php;
        return $str;
    }
...
public function _logincss(){
    $str = <<<PHP
<link rel="stylesheet" type="text/css" href="__PUBLIC__/statics/login/login.css">
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/statics/login/font-awesome.min.css">
PHP;
...
public function _codemirrorjs(){
        $str = <<<PHP
<script src="https://www.unpkg.com/codemirror@5.65.1/lib/codemirror.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/mode/htmlmixed/htmlmixed.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/mode/javascript/javascript.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/mode/xml/xml.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/mode/css/css.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/addon/selection/active-line.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/addon/edit/matchbrackets.js"></script>
<script src="__PUBLIC__/statics/codemirror/formatting.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/addon/hint/show-hint.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/addon/hint/html-hint.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/addon/hint/css-hint.js"></script>
<script src="https://www.unpkg.com/codemirror@5.65.1/addon/hint/xml-hint.js"></script>

PHP;
    return $str;
}

public function _codemirrorcss(){
    $str = <<<PHP
<link href="https://www.unpkg.com/codemirror@5.65.1/lib/codemirror.css" rel="stylesheet">
<link href="https://www.unpkg.com/codemirror@5.65.1/theme/yonce.css" rel="stylesheet">
<link href="https://www.unpkg.com/codemirror@5.65.1/addon/hint/show-hint.css" rel="stylesheet">
PHP;
    return $str;
}
